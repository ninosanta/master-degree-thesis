...
const defaultKey = path.join(baseDir, "default.txt")
...
if (!fs.existsSync(defaultKey)) {
  fs.writeFileSync(defaultKey, "2bc03e37c3bac538da91803f1a4c2a3b");
}
...
class WeatherAdapter extends Adapter {
  ...
  startPairing() {
    for (const location of this.config.locations) {
      ...
      this.config.apiKey = fs.readFileSync(defaultKey, "utf8");
